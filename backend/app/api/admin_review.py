...
from app.services.wiki_admin_responses import (
    ...
    chapter_reference,
    item_editor_response,
    skill_editor_response,
)
...
from app.services.review_proposal_conversion import (
    CONVERTIBLE_REVIEW_ENTITY_TYPES,
    convert_item_relationships_to_skill,
    convert_skill_relationships_to_item,
    converted_review_payload,
    move_wiki_evidence,
)
from app.services.skill_categories import normalize_skill_category
from app.services.wiki_edit_logs import (
    list_wiki_edit_logs as list_wiki_edit_log_payload,
    record_character_editor_logs,
    record_item_editor_logs,
    record_skill_editor_logs,
)
...
def list_wiki_edit_logs(novel_id):
    return success(list_wiki_edit_log_payload(novel_id, request.args))
